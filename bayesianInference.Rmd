...
> The following section includes personal notes and experiments that apply Bayesian hypothesis testing directly into computational intelligence and, thus, diverge significantly from the source material.
...
$d_1$: choose $H_1$: agent decides that it's in danger 
